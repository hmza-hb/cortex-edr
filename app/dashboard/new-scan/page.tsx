                ...
                <form className="space-y-8 relative z-10" onSubmit={handleStartScan}>
                    ...
                    <div className="flex gap-4 pt-4">
                        <Button
                            type="submit"
                            disabled={isLoading}
                            className="flex-1 h-16 bg-purple-500 hover:bg-purple-600 text-black font-black text-[10px] tracking-[0.3em] uppercase rounded-2xl transition-all shadow-xl shadow-blue-500/10 active:scale-[0.98] disabled:opacity-50"
                        >
                            {isLoading ? (
                                <>
