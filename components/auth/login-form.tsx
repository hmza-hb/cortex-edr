                ...
                <div className="space-y-8">
                    {mode !== "forgot-pass" && (
                        <>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <Button
                                    variant="outline"
                                    className="h-12 bg-white/[0.1] border-white/30 hover:bg-white/[0.2] hover:border-white text-white text-[11px] font-mono uppercase tracking-[0.2em] transition-all shadow-[0_0_20px_-5px_rgba(255,255,255,0.2)] disabled:opacity-50 disabled:cursor-not-allowed"
                                    onClick={() => {
                    ...
                    <form action={(formData) => {
                        ...
                        <AnimatePresence mode="wait">
                            ...
                            >
                                <Button
                                    className="w-full h-12 bg-white text-black hover:bg-neutral-200 font-mono uppercase tracking-[0.3em] text-[11px] font-black shadow-[0_0_30px_-5px_rgba(255,255,255,0.4)] transition-all duration-500 relative group overflow-hidden disabled:opacity-50 disabled:cursor-not-allowed"
                                    type="submit"
                                    disabled={isGithubLoading || isGoogleLoading || isFormLoading}
                                >
                                    ...
                                    <span className="relative text-black flex items-center justify-center gap-2">
                                        ...
                                        {isFormLoading ? "PROCESSING..." : (mode === "signin" ? "SIGN IN" : mode === "signup" ? "CREATE ACCOUNT" : "SEND RECOVERY KEY")}
                                    </span>
                                </Button>
                            </motion.div>
                        </AnimatePresence>
