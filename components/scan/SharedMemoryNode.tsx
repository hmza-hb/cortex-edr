...
export const SharedMemoryNode = React.forwardRef<HTMLDivElement, SharedMemoryNodeProps>(
    ({ issuesCount, active, className }, ref) => {
        return (
            <div
                ref={ref}
                className={cn(
                    "w-[220px] h-[260px] p-[8px] rounded-[20px] border-2 bg-[#020202]/90 backdrop-blur-3xl flex flex-col items-center justify-center gap-5 transition-all duration-1000",
            ...
            >
                {/* Brain Icon Core */}
                <div className={cn(
                    "p-1 rounded-full bg-purple-500/10 border border-purple-500/30 relative shadow-[inset_0_0_20px_rgba(168,85,247,0.1)]",
                ...
                <div className="text-center">
                    ...
                    <div className="flex items-center justify-center gap-2">
                        ...
                        <p className="text-[9px] text-purple-400/60 font-black tracking-[0.2em] uppercase">The Orchestrator</p>
                        <span className="w-4 h-[1px] bg-purple-500/30" />
                    </div>
                </div>
                ...
                <div className="w-full space-y-3">
                    <div className="w-full flex justify-between items-center py-4 px-6 rounded-2xl bg-white/[0.03] border border-white/5 relative group cursor-default">
                        <div className="flex items-center gap-3">
                            ...
                            <span className="text-[11px] font-black text-white/50 tracking-widest uppercase">Finding</span>
                        </div>
...
SharedMemoryNode.displayName = 'SharedMemoryNode';
